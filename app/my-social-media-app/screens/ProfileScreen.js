      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.loadingContainer}>
          <View style={styles.loadingSpinner}>
            <Ionicons name="hourglass-outline" size={24} color="#E60023" />
          </View>
          <Text style={styles.loadingSubtext}>Loading your profile...</Text>
        </View>
      </SafeAreaView>
    );
  }
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={handleLogout} style={styles.logoutButton}>
          <Ionicons name="power" size={18} color="#E60023" />
        </TouchableOpacity>
      </View>
      ...
      >
        ...
        <View style={styles.profileCard}>
          ...
          <View style={styles.statsContainer}>
            <TouchableOpacity
              style={[styles.statItem, styles.statItemLeft]}
              onPress={() =>
                navigation.navigate("Follow List", {
                  mode: "followers",
            ...
            <TouchableOpacity
              style={[styles.statItem, styles.statItemRight]}
              onPress={() =>
                navigation.navigate("Follow List", {
                  mode: "following",
                  followers: user.followers,
        ...
        <View style={styles.infoCardsContainer}>
          <View style={styles.infoCard}>
            ...
            <Text style={styles.infoCardText}>2025</Text>
          </View>
